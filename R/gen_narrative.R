...
# (ARCHIVE_DOCX below points at heat-related-deaths' source file). Point at
# the new indicator's archived .docx and use docx_sections() in
# R/utils/read_docx.R to find this document's own heading boundaries instead
# of reusing the paragraph index ranges below, which are specific to
# heat-related-deaths' document. See README.md step 4.
# ============================================================================
#
